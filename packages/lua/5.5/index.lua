...
index = {
  ...
  ["dev-roshangeorge-ljsonschema.zip"] = {
    ["dev-roshangeorge-ljsonschema-1.0.0"] = {
      dependencies = {
        "lua >= 5.1",
        "net-url"
      },
  ...
  ["dromozoa-amalgamate.zip"] = {
    ["dromozoa-amalgamate-1.4"] = {
      dependencies = {
        "dromozoa-commons"
      },
      description = {
  ...
  ["dromozoa-calendar.zip"] = {
    ["dromozoa-calendar-1.13"] = {
      description = {
  ...
  ["dromozoa-commons.zip"] = {
    ["dromozoa-commons-1.64"] = {
      description = {
  ...
  ["dromozoa-serializer.zip"] = {
    ["dromozoa-serializer-1.5"] = {
      description = {
  ...
  ["dromozoa-vecmath.zip"] = {
    ["dromozoa-vecmath-1.17"] = {
      description = {
  ...
  ["figurate-numbers.zip"] = {
    ["figurate-numbers-0.8.0"] = {
      dependencies = {
        "lua >= 5.1"
      },
      description = {
  ...
  ["lua-glob-pattern.zip"] = {
    ["lua-glob-pattern-0.2.1.20120406"] = {
      dependencies = {
        "lua >= 5.1"
      },
      description = {
  ...
  ["multipart-formdata-lib.zip"] = {
    ["multipart-formdata-lib-1.0"] = {
      dependencies = {
        "lua >= 5.1"
      },
      description = {
